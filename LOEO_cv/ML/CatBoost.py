...
# Load and validate LOEO split file
...
# Only learning_rate and iterations are searched
...
for iteration, leave_name in enumerate(
    ...
    # Merge full training environments
    ...
    with open(
        ...
        f.write(
            f"Fixed l2_leaf_reg: 3.0\n"
        )

        f.write(
            f"Fixed subsample: 0.8\n"
        )
...
print(
    "LOEO CATBOOST GRID SEARCH COMPLETE"
)
